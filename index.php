...
<nav>
    <div class="nav-inner">
        ...
        <div class="auth-buttons hidden" id="nav-user">
            <span id="nav-username-text" style="color:#cce8f0;font-size:0.85rem;padding:5px 8px;display:inline-block;"></span>
...
<div id="page-home" class="page">
    ...
    <div class="about-summary">
        <h2>About Us</h2>
        <p>We are a <strong>Saudi Auction house website</strong> who strive for a <em>fair and easy to use bidding experience</em>. Mazadi was founded to introduce a trusted online auction platform to the Saudi market.</p>
    ...
    <div class="section">
        ...
        <div class="about-layout">
            <div class="about-image-col">
                <img src="https://images.unsplash.com/photo-1633457896836-f8d6025c85d1?w=800&q=80" alt="The Mazadi Team" class="about-img">
                <p class="img-caption">The Mazadi Team — committed to fair auctions</p>
            </div>
            <div class="about-text-col">
                <h3>Who We Are</h3>
                <p>We are a <strong>Saudi Auction house website</strong> who strive for a <em>fair and easy to use bidding experience</em>. Mazadi (مزادي) was built to fill a gap in the Saudi digital market: the lack of a trusted, transparent, and accessible online auction platform.</p>
                <p>Our platform allows <strong>anyone</strong> to auction off vehicles, electronics, watches, collectibles, and more — while giving bidders the confidence that the price they pay is <u>dictated by the market</u>, not by a seller.</p>
                <p>Whether you are in <strong>Riyadh, Jeddah, Dammam</strong>, or anywhere in the world, Mazadi gives you access to authentic items at fair prices.</p>
            </div>
        </div>
        ...
        <div class="cards-row">
            <div class="card">
                ...
                <p>To provide Saudi Arabia with a safe, fair, and transparent online auction platform that simplifies the buying and selling experience for everyone.</p>
            </div>
            <div class="card">
                <p class="card-icon">🌍</p><h4>Global Reach</h4>
                <p>For buyers outside Saudi Arabia, Mazadi removes the guesswork on pricing. The competitive bidding process ensures you pay what the item is truly worth.</p>
            </div>
            <div class="card">
                <p class="card-icon">🛡️</p><h4>Trust &amp; Safety</h4>
                <p>Every listing is reviewed by our admin team. Problematic auctions are flagged and removed promptly to maintain the integrity of our platform.</p>
            </div>
        </div>
        ...
        <div class="project-info">
            ...
            <p><strong>Target Audience:</strong> People in Saudi Arabia and worldwide looking to buy or sell used items at fair market prices</p>
            <p><strong>Course:</strong> IT 1390 Web Systems — Al Imam Mohammad Ibn Saud Islamic University, 1st Semester 2026</p>
        </div>
    </div>
</div>
...
<div id="page-item" class="page hidden">
    <div class="section">
        ...
        <img id="item-main-img" src="https://images.unsplash.com/photo-1672173625722-04fd626667e1?w=900&q=80" alt="Auction Item" class="item-main-img">
        ...
        <div class="add-review">
            ...
            <form onsubmit="submitReview(event)">
                ...
                <div class="form-group">
                    ...
                    <textarea id="review-body" rows="4" placeholder="Share your experience with this auction..." required></textarea>
                </div>
...
<div id="page-login" class="page hidden">
    <div class="auth-container">
        ...
        <div id="form-login">
            <h2>Log In</h2>
            <p style="text-align:center;color:#777;font-style:italic;margin-bottom:20px;">Welcome back to Mazadi — مزادي</p>
            <div class="dark-form">
                ...
                <p class="switch-link">Don't have an account? <a onclick="switchAuthTab('signup')" style="cursor:pointer;">Sign Up</a></p>
            </div>
        </div>

        <div id="form-signup" class="hidden">
            <h2>Sign Up</h2>
            <p style="text-align:center;color:#777;font-style:italic;margin-bottom:20px;">Create your free Mazadi account</p>
            <div class="dark-form">
                ...
                <p class="switch-link">Already have an account? <a onclick="switchAuthTab('login')" style="cursor:pointer;">Log In</a></p>
            </div>
        </div>
...
<div id="page-create" class="page hidden">
    <div class="section" style="max-width:700px;margin:0 auto;">
        ...
        <p style="text-align:center;font-style:italic;color:#777;margin-bottom:24px;">Fill in the details below to list your item for bidding on Mazadi</p>
        ...
        <form onsubmit="submitAuction(event)">
            <div class="form-group">
                ...
                <div class="upload-box" onclick="document.getElementById('img-file-input').click()">
                    ...
                    <input type="file" id="img-file-input" accept="image/*" style="display:none;" onchange="previewImage(event)">
                </div>
            </div>

            <div class="form-group">
                <label for="item-name">Item Name *</label>
                <input type="text" id="item-name" placeholder="e.g. 1972 Ford Mustang – Classic Muscle Car" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="item-desc" rows="6" placeholder="Describe your item: condition, history, what's included, etc." required></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="item-location" placeholder="e.g. Riyadh, Jeddah, Dammam..." required>
            </div>
...
<div id="page-admin-login" class="page hidden">
    <div class="auth-container">
        ...
        <p style="text-align:center;font-style:italic;color:#777;margin-bottom:24px;">This page is restricted to authorized administrators only.</p>
...
<div id="page-admin-panel" class="page hidden">
    ...
    <div class="admin-page-header">
        <h2>Control Panel</h2>
        <p style="font-style:italic;color:#f0d0b0;font-size:0.88rem;margin-top:4px;">Mazadi Admin Dashboard</p>
    </div>
    ...
    <div class="section">
        ...
        <div class="admin-tab-content">
            ...
            <div id="admin-menu" class="admin-panel">
                ...
                <p style="color:#555;font-size:0.88rem;margin-bottom:20px;">Overview of help requests, auction details, and user bidding activity.</p>
                ...
                <h4 style="border-bottom:1px solid #1a6b8a;padding-bottom:6px;margin-top:24px;margin-bottom:14px;">User activity map showing most popular auctions:</h4>
            ...
            <div id="admin-editor" class="admin-panel hidden">
                ...
                <p style="color:#555;font-size:0.88rem;margin-bottom:20px;">Select an active auction, then edit its details below.</p>
                ...
                <div id="edit-form-wrapper" class="hidden" style="margin-top:20px;border:2px solid #1a6b8a;border-radius:6px;padding:18px;">
            ...
            <div id="admin-remover" class="admin-panel hidden">
                ...
                <p style="color:#555;font-size:0.88rem;margin-bottom:20px;">Select a problematic or completed auction to remove it from the platform.</p>
        ...
        <p style="text-align:center;margin-top:16px;">
            <a onclick="showPage('home')" style="color:#8b4513;font-size:0.88rem;cursor:pointer;">← Back to Main Website</a>
        </p>
...
<footer>
    ...
    <p class="footer-copy">© 2026 Mazadi. IT 1390 Web Systems Project – Al Imam Mohammad Ibn Saud Islamic University.</p>
</footer>
...
async function loadAuctions(search) {
    ...
    try {
        ...
        if (c) c.innerHTML =
            '<p style="color:#c0392b;padding:20px 0;">⚠️ Could not reach the server. Make sure XAMPP (Apache + MySQL) is running, and open this page as <strong>http://localhost/mazadi/index.php</strong></p>';
    }
}
...
async function showItemPage(id) {
    ...
    try {
        ...
        document.getElementById('item-meta').textContent = '📍 ' + a.location + ' | 🗂️ ' + a.category + ' | 👤 Seller: ' + a.seller_name;
        document.getElementById('item-date').textContent = '📅 Created: ' + a.created_at.split(' ')[0] + ' | ⭐ Rating: ' + avgRating(a.reviews) + ' / 5';
        ...
        document.getElementById('item-bids').innerHTML = a.bid_count + ' bids | Ends in: <strong class="urgent">' + fmtEnds(a.ends_at) + '</strong>';
        document.getElementById('item-main-img').src = a.image_url || 'https://images.unsplash.com/photo-1607603289612-71ae134aa577?w=900&q=80';
    ...
    } catch (e) { document.getElementById('item-title').textContent = 'Failed to load auction.'; }
}
...
function loadReviews(reviews) {
    ...
    if (!reviews || !reviews.length) {
        ...
        reviews.forEach(function (r) {
            ...
            card.innerHTML = '<div class="review-header"><strong>' + esc(r.reviewer_name) + '</strong>' +
...
async function submitReview(event) {
    ...
    try {
        ...
        var card = document.createElement('div');
        card.className = 'review-card';
        card.innerHTML = '<div class="review-header"><strong>' + esc(name) + '</strong>' +
        ...
        document.getElementById('review-count').textContent = parseInt(document.getElementById('review-count').textContent) + 1;
...
function switchAuthTab(tab) {
    ...
    document.getElementById('tab-' + (tab === 'login' ? 'signup' : 'login')).classList.remove('active');
...
async function handleSignup(event) {
    event.preventDefault();
    var u = document.getElementById('signup-user').value.trim();
    ...
    try {
        ...
        updateNavForUser();
        showPage('home');
    } catch (err) { msg.textContent = '❌ Registration failed.'; }
}
...
async function submitAuction(event) {
    ...
    var start = document.getElementById('starting-bid').value;
    var dur = document.getElementById('duration').value;
    var loc = document.getElementById('item-location').value.trim();
    var imageUrl = '';
    if (fileInput.files && fileInput.files[0]) {
        var formData = new FormData();
        formData.append('image', fileInput.files[0]);
        try {
            var uploadRes = await (await fetch(API + 'upload.php', { method: 'POST', body: formData })).json();
            if (uploadRes.image_url) imageUrl = uploadRes.image_url;
        } catch(e) { alert('Image upload failed, creating auction without image.'); }
    }
    try {
        var d = await (await fetch(API + 'auctions.php', {
            method: 'POST',
            headers: {'Content-Type':'application/json'},
            body: JSON.stringify({ title: title, category: cat, description: desc, starting_bid: start, duration: dur, location: loc, image_url: imageUrl })
        })).json();
        if (d.error) { alert('❌ ' + d.error); }
        else { alert('✅ Auction created successfully!'); showPage('home'); }
    } catch (e) { alert('❌ Failed to submit auction.'); }
}
...
function switchAdminTab(tab) {
    ...
    var p = document.getElementById('admin-' + tab);
    if (p) p.classList.remove('hidden');
    var b = document.getElementById('atab-' + tab);
    if (b) b.classList.add('active');
    if (tab === 'editor')  loadAdminAuctionSelects();
    if (tab === 'remover') loadAdminAuctionSelects();
    if (tab === 'menu')    loadAdminMenu();
}

async function loadAdminMenu() {
    try {
        var stats = await (await fetch(API + 'auctions.php?action=stats')).json();
        var html = '<p><strong>Total Active Auctions:</strong> ' + stats.total_auctions + '</p>' +
                   '<p><strong>Total Bids Placed:</strong> ' + stats.total_bids + '</p>' +
                   '<p><strong>Total Active Users:</strong> ' + stats.total_users + '</p>';
        document.getElementById('admin-stats-content').innerHTML = html;
    } catch(e) {
        document.getElementById('admin-stats-content').innerHTML = '<p style="color:#ff8a8a;">Failed to load live stats.</p>';
    }
}

async function loadAdminAuctionSelects() {
    var editSel = document.getElementById('edit-select');
    var remCard = document.getElementById('admin-remover-cards');
    try {
        ...
        if (editSel) {
            ...
            auctions.forEach(function(a){
                editSel.innerHTML += '<option value="' + a.id + '">#' + a.id + ' - ' + esc(a.title) + '</option>';
            });
        }
        if (remCard) {
            if (!auctions.length) { remCard.innerHTML = '<p>No auctions available.</p>'; return; }
            remCard.innerHTML = auctions.map(function(a){
                return '<div class="admin-radio-card" id="radio-' + a.id + '" onclick="selectDelete(' + a.id + ')">' +
                       '<input type="radio" name=\"del-auction\" value="' + a.id + '" id="rad-input-' + a.id + '">' +
                       '<label for="rad-input-' + a.id + '"><strong>#' + a.id + ' - ' + esc(a.title) + '</strong> (' + esc(a.category) + ')<br><span style="color:#777;">Current bid: ' + fmtSAR(a.current_bid) + '</span></label></div>';
            }).join('');
        }
    } catch(e){}
}
...
async function loadEditForm() {
    ...
    var wrapper = document.getElementById('edit-form-wrapper');
    if (!id) { wrapper.classList.add('hidden'); return; }
    try {
        var a = await (await fetch(API + 'auctions.php?id=' + id)).json();
...
async function saveEdit() {
    var id = document.getElementById('edit-select').value;
    var title = document.getElementById('edit-name').value.trim();
    var desc  = document.getElementById('edit-desc').value.trim();
    var bid   = document.getElementById('edit-bid').value;
    var msg   = document.getElementById('edit-message');
    try {
        var d = await (await fetch(API + 'auctions.php?id=' + id, {
            method: 'PUT',
            headers: {'Content-Type':'application/json'},
            body: JSON.stringify({title: title, description: desc, starting_bid: bid})
        })).json();
        if (d.error) { msg.textContent = '❌ ' + d.error; msg.className = 'bid-message error'; }
        else { msg.textContent = '✅ Auction updated successfully!'; msg.className = 'bid-message success'; loadAdminAuctionSelects(); }
    } catch(e) { msg.textContent = '❌ Failed to save.'; msg.className = 'bid-message error'; }
}

function selectDelete(id) {
    var rad = document.getElementById('rad-input-' + id);
    if (rad) rad.checked = true;
    document.querySelectorAll('.admin-radio-card').forEach(function(c){ c.classList.remove('selected'); });
    var card = document.getElementById('radio-' + id);
...
async function deleteAuction(event) {
    ...
    try {
        var d = await (await fetch(API + 'auctions.php?id=' + sel.value, { method: 'DELETE' })).json();
        if (d.error) { msg.textContent = '❌ ' + d.error; msg.className = 'bid-message error'; }
        else {
...
function fmtEnds(endsAt) {
    ...
    var label = d > 0 ? d+'d '+h+'h '+m+'m' : h+'h '+m+'m';
    return label;
}
function avgRating(reviews) {
    if (!reviews || !reviews.length) return '—';
    var sum = 0;
    reviews.forEach(function(r){ sum += parseInt(r.rating); });
